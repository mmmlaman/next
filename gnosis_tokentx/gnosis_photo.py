...
# Load the CSV file
data_all_groups = pd.read_csv("D:/sybil/gnosis_tokentx_token_transfers_per_group.csv")  # Replace with your actual path
...
def plot_graph_for_column(column, index):
    ...
    ax.set_title(f"Address Relationship for gnosis_tokentx_group{index} with Shell Layout", fontsize=16, pad=20)

    output_path = os.path.join(output_directory, f"gnosis_tokentx_group{index}.png")
