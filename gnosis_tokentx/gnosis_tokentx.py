...
df_related_addresses.to_csv(r"D:\sybil\gnosis_tokentx_related_address_pairs.csv", index=False)

print("Related address pairs on Optimism have been saved to gnosis_tokentx_related_address_pairs.csv.")
